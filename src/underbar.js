(function() {
  ...
  _.every = function(collection, iterator) {
    ...
    var checkTest = iterator || _.identity;

    return _.reduce(collection, function(checkResult, item) {
        return checkResult? Boolean(checkTest(item)): false;
    }, true);
  };
  ...
  _.some = function(collection, iterator) {
    ...
    var checkTest = iterator || _.identity;
    //Check the oppisite of every ===none, then negate none ===some
    return !_.every(collection, function(item){
      return !checkTest(item);
    })
  };
  ...
  _.memoize = function(func) {
    ...
    return function() {
      //Brian: convert the arguments to array for results to store. 
